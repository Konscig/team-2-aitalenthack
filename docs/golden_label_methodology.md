...
котировке, диагностические поля, булеву метку `good` и бинарную метку
`closing ∈ {0, 1}`.
...
| Коридор | Рабочих дней | `good = True` | `closing = 1` |
|---|---:|---:|---:|
| AMD_RUB | 1 981 | 579 | 101 |
| KGS_RUB | 1 981 | 611 | 91 |
| KZT_RUB | 1 981 | 659 | 89 |
| TJS_RUB | 1 981 | 606 | 109 |
| UZS_RUB | 1 981 | 575 | 94 |
